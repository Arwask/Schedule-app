...
//schedule routes
router.get('/manager/manager-schedule', isLoggedIn, isManager, getManagerSchedule);
router.post('/manager/manager-schedule', isLoggedIn, isManager, postManagerSchedule);
